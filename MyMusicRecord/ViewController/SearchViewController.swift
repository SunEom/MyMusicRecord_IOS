            ...
            .responseJSON() { response in
                ...
                case .success(let value):
                    ...
                    for posting in postings {
                        ...
                        self.resultPostings.append(Posting(title: title, artist: artist, genre: genre, nickname: nickname, postBody: postBody, postNum: postNum, writerId: writerId, createdDate: createdDate))
                    }
